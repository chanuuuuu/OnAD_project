...
def start (date, streamer_id, twitch_chat_dir, count=5):
    '''
    ...
    try:
        for days in range(7):
            ...
            with open(twitch_chat_dir + '/#{}/{}_#{}.log'.format(streamer_id, date, streamer_id),'r',encoding='utf-8') as f:
        ...
        return print("{}의 {}일자 채팅로그 파일이 없습니다".format(streamer_id, date))

    return len(target_user), len(big_fan)
    

print(start("2018-12-26","cocopopp671"))